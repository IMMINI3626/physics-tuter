...
const misconceptions = [
  ...
  // ── 운동량 (unit 2) — 이종주 (2009) ──────────────────────────────────────
  { id:'MO1', unitId:'2', dimensionCode:'MO', code:'MO1', name_ko:'충돌 후 질량 큰 쪽이 더 빠르다', name_en:'Heavier object moves faster after collision',
  ...
  { id:'MO2', unitId:'2', dimensionCode:'MO', code:'MO2', name_ko:'완전비탄성충돌 시 운동량 감소', name_en:'Momentum decreases in perfectly inelastic collision',
    description:'두 물체가 충돌 후 합쳐지면 운동량이 손실된다고 믿음',
    correctConcept:'충돌 형태(탄성/비탄성)와 무관하게 외력이 없으면 총 운동량은 보존된다',
    sourcePaper:'이종주 (2009), 연세대학교 교육대학원 석사학위논문' },
  { id:'MO3', unitId:'2', dimensionCode:'MO', code:'MO3', name_ko:'운동량 클수록 가속도 증가', name_en:'Greater momentum implies greater acceleration',
    description:'운동량이 클수록 가속도도 크다고 믿음',
    correctConcept:'가속도는 알짜힘을 질량으로 나눈 값(a=F/m)이며 운동량의 크기와 직접적 관계가 없다',
    sourcePaper:'이종주 (2009), 연세대학교 교육대학원 석사학위논문' },

  // ── 전기 회로 (unit 3) — 이승노 (2006) ──────────────────────────────────
  { id:'EC1', unitId:'3', dimensionCode:'EC', code:'EC1', name_ko:'직렬회로 전류 소모 모형', name_en:'Current consumption model in series circuit',
  ...
  { id:'EC2', unitId:'3', dimensionCode:'EC', code:'EC2', name_ko:'전압·전류 혼동', name_en:'Confusion between voltage and current',
    ...
    sourcePaper:'이승노 (2006), 전·자기 영역의 오개념 분석, 한국교원대학교 석사학위논문' },
  { id:'EC3', unitId:'3', dimensionCode:'EC', code:'EC3', name_ko:'병렬 연결 = 저항 증가', name_en:'Parallel connection increases total resistance',
    description:'저항을 병렬로 연결하면 전체 저항이 증가한다고 믿음',
    correctConcept:'저항을 병렬로 연결하면 전류 경로가 늘어나 전체 저항은 각 저항보다 작아진다 (1/R합 = 1/R1 + 1/R2)',
    sourcePaper:'이승노 (2006), 전·자기 영역의 오개념 분석, 한국교원대학교 석사학위논문' },
  { id:'EC4', unitId:'3', dimensionCode:'EC', code:'EC4', name_ko:'전지 거리 비례 전류', name_en:'Current weakens with distance from battery',
    description:'전지에서 멀수록 전류가 약해진다고 믿음',
    correctConcept:'이상적인 도선에서 전류는 위치에 관계없이 일정하며, 전지의 기전력이 회로 전체를 순환하는 전류를 결정한다',
    sourcePaper:'이승노 (2006), 전·자기 영역의 오개념 분석, 한국교원대학교 석사학위논문' },
  { id:'EC5', unitId:'3', dimensionCode:'EC', code:'EC5', name_ko:'전류 방향 = 전자 이동 방향', name_en:'Current flows in the same direction as electrons',
    description:'전류의 방향이 전자의 이동 방향과 같다고 믿음',
    correctConcept:'전류의 방향은 양(+)전하의 이동 방향으로 정의되며, 전자(음전하)의 이동 방향과 반대이다',
    sourcePaper:'이승노 (2006), 전·자기 영역의 오개념 분석, 한국교원대학교 석사학위논문' },
  { id:'EC6', unitId:'3', dimensionCode:'EC', code:'EC6', name_ko:'저항 = 전류 차단', name_en:'Resistance completely blocks current',
    description:'저항은 전류를 완전히 막는 장치라고 믿음',
    correctConcept:'저항은 전류의 흐름을 방해하지만 차단하지는 않는다. 전류는 I=V/R 로 저항에 반비례하여 흐른다',
    sourcePaper:'이승노 (2006), 전·자기 영역의 오개념 분석, 한국교원대학교 석사학위논문' },

  // ── 자기장 (unit 3) — 이승노 (2006) ─────────────────────────────────────
  { id:'MF1', unitId:'3', dimensionCode:'MF', code:'MF1', name_ko:'직선 도선 자기장 방향 오해', name_en:'Magnetic field direction parallel to current',
    description:'직선 도선 주변의 자기장이 전류 방향과 평행하게 형성된다고 믿음',
    correctConcept:'직선 도선 주변의 자기장은 전류 방향에 수직한 동심원 형태로 형성된다 (오른나사 법칙)',
    sourcePaper:'이승노 (2006), 전·자기 영역의 오개념 분석, 한국교원대학교 석사학위논문' },
  { id:'MF2', unitId:'3', dimensionCode:'MF', code:'MF2', name_ko:'자기장 세기 거리 무관', name_en:'Magnetic field strength independent of distance',
    description:'도선에서 멀어져도 자기장의 세기가 일정하다고 믿음',
    correctConcept:'직선 도선에서 자기장의 세기는 거리에 반비례한다 (B ∝ 1/r)',
    sourcePaper:'이승노 (2006), 전·자기 영역의 오개념 분석, 한국교원대학교 석사학위논문' },
  { id:'MF3', unitId:'3', dimensionCode:'MF', code:'MF3', name_ko:'같은 방향 전류 도선 = 반발', name_en:'Parallel currents in same direction repel',
    description:'같은 방향으로 전류가 흐르는 두 평행 도선이 서로 밀어낸다고 믿음',
    correctConcept:'같은 방향으로 전류가 흐르는 두 평행 도선은 서로 당기는 힘(인력)이 작용한다',
    sourcePaper:'이승노 (2006), 전·자기 영역의 오개념 분석, 한국교원대학교 석사학위논문' },
  { id:'MF4', unitId:'3', dimensionCode:'MF', code:'MF4', name_ko:'N극에서만 자기력선 시작', name_en:'Magnetic field lines only emerge from N pole',
    description:'자기력선이 N극에서만 나오고 S극으로 들어가지 않는다고 믿음',
    correctConcept:'자기력선은 N극에서 나와 S극으로 들어가는 연속된 닫힌 곡선이며, 도중에 끊어지거나 생성/소멸하지 않는다',
    sourcePaper:'이승노 (2006), 전·자기 영역의 오개념 분석, 한국교원대학교 석사학위논문' },
  { id:'MF5', unitId:'3', dimensionCode:'MF', code:'MF5', name_ko:'코일 자기장 방향 직관 판단', name_en:'Intuitive judgment of coil magnetic field direction',
    ...
    sourcePaper:'이승노 (2006), 전·자기 영역의 오개념 분석, 한국교원대학교 석사학위논문' },
  { id:'MF6', unitId:'3', dimensionCode:'MF', code:'MF6', name_ko:'자기장 세기 전류 비례 부정', name_en:'Magnetic field not proportional to current',
    description:'전류를 2배로 늘려도 자기장이 2배가 되지 않는다고 믿음',
    correctConcept:'직선 도선에서 자기장의 세기는 전류에 비례한다 (B ∝ I). 전류가 2배이면 자기장도 2배이다',
    sourcePaper:'이승노 (2006), 전·자기 영역의 오개념 분석, 한국교원대학교 석사학위논문' },
  { id:'MF7', unitId:'3', dimensionCode:'MF', code:'MF7', name_ko:'전자석·영구자석 원리 무관', name_en:'Electromagnet and permanent magnet operate on different principles',
  ...
  { id:'EMI1', unitId:'3', dimensionCode:'EMI', code:'EMI1', name_ko:'정지 자석 = 유도 전류', name_en:'Stationary magnet induces current',
  ...
  { id:'EMI2', unitId:'3', dimensionCode:'EMI', code:'EMI2', name_ko:'자기장 세기 = 유도 기전력', name_en:'Stronger magnetic field always means larger EMF',
    description:'자기장이 강하면 무조건 유도 기전력이 크다고 믿음',
    correctConcept:'유도 기전력의 크기는 자기선속의 변화율(ΔΦ/Δt)에 비례한다. 자기장이 강해도 변화가 없으면 유도 기전력은 0이다',
    sourcePaper:'이승노 (2006), 전·자기 영역의 오개념 분석, 한국교원대학교 석사학위논문; 연구 기반 추론' },
  { id:'EMI3', unitId:'3', dimensionCode:'EMI', code:'EMI3', name_ko:'개방 회로에서 유도 전류', name_en:'Induced current flows in open circuit',
  ...
  { id:'EMI4', unitId:'3', dimensionCode:'EMI', code:'EMI4', name_ko:'유도 전류 방향 = N극 방향', name_en:'Induced current direction follows N pole direction',
    ...
    sourcePaper:'이승노 (2006), 전·자기 영역의 오개념 분석, 한국교원대학교 석사학위논문; 연구 기반 추론' },
  { id:'EMI5', unitId:'3', dimensionCode:'EMI', code:'EMI5', name_ko:'렌츠 법칙 = 완전 상쇄', name_en:'Lenz\'s law means complete cancellation of magnetic field',
  ...
  { id:'AT1', unitId:'3', dimensionCode:'AT', code:'AT1', name_ko:'스펙트럼 선 = 원자 속 입자', name_en:'Spectral lines represent particles inside atom',
  ...
  { id:'AT2', unitId:'3', dimensionCode:'AT', code:'AT2', name_ko:'스펙트럼선↔에너지 준위 미연결', name_en:'Spectral lines not connected to energy level transitions',
    ...
    sourcePaper:'장숙경 (2014), 원자 모형과 그 변천 과정에 대한 고등학생들의 이해 조사, 이화여대 석사학위논문' },
  { id:'AT3', unitId:'3', dimensionCode:'AT', code:'AT3', name_ko:'에너지 불연속 개념 미획득', name_en:'Failure to understand discrete energy levels',
    ...
    sourcePaper:'장숙경 (2014), 원자 모형과 그 변천 과정에 대한 고등학생들의 이해 조사, 이화여대 석사학위논문' },
  { id:'AT4', unitId:'3', dimensionCode:'AT', code:'AT4', name_ko:'오비탈 = 전자 궤도', name_en:'Orbital is the actual orbit of electron',
    description:'오비탈이 확률밀도 분포가 아닌 전자가 실제로 도는 궤도라고 믿음',
    correctConcept:'오비탈은 전자가 발견될 확률이 높은 공간 영역(확률밀도함수)이며, 전자가 일정한 궤도를 도는 것이 아니다',
    sourcePaper:'장숙경 (2014), 원자 모형과 그 변천 과정에 대한 고등학생들의 이해 조사, 이화여대 석사학위논문' },
  { id:'AT5', unitId:'3', dimensionCode:'AT', code:'AT5', name_ko:'점밀도 그림 점 = 개별 전자', name_en:'Dots in electron cloud represent individual electrons',
    ...
    sourcePaper:'장숙경 (2014), 원자 모형과 그 변천 과정에 대한 고등학생들의 이해 조사, 이화여대 석사학위논문' },
  { id:'AT6', unitId:'3', dimensionCode:'AT', code:'AT6', name_ko:'에너지 준위 = 원자핵 거리', name_en:'Energy level determined only by distance from nucleus',
  ...
  { id:'EB1', unitId:'3', dimensionCode:'EB', code:'EB1', name_ko:'에너지 띠 ≠ 에너지 준위 연장', name_en:'Energy band not seen as extension of atomic energy levels',
  ...
  { id:'EB2', unitId:'3', dimensionCode:'EB', code:'EB2', name_ko:'반도체 = 불완전 도체', name_en:'Semiconductor seen as imperfect conductor',
    description:'반도체를 에너지 띠 간격으로 설명되는 별개 물질이 아닌 "나쁜 도체"로만 인식함',
    correctConcept:'도체·반도체·절연체의 차이는 전도띠와 원자가띠 사이의 에너지 간격(띠 간격) 크기로 설명된다',
    sourcePaper:'장숙경 (2014), 원자 모형 오개념 연구 간접 근거; 연구 기반 추론' },
  { id:'EB3', unitId:'3', dimensionCode:'EB', code:'EB3', name_ko:'도핑 → 전하 생성', name_en:'Doping creates new charges',
  ...
  { id:'WR1', unitId:'4', dimensionCode:'WR', code:'WR1', name_ko:'굴절 시 속도 불변', name_en:'Speed unchanged during refraction',
  ...
  { id:'WR2', unitId:'4', dimensionCode:'WR', code:'WR2', name_ko:'굴절각 클수록 속도 증가', name_en:'Larger refraction angle means faster speed',
    ...
    sourcePaper:'최정훈 (2015), 중학교 학생들의 빛 관련 오개념 연구, 충북대학교 석사학위논문' },
  { id:'WR3', unitId:'4', dimensionCode:'WR', code:'WR3', name_ko:'전반사 = 모든 각도 가능', name_en:'Total internal reflection can occur at any angle',
    description:'전반사가 어떤 각도에서도 일어날 수 있다고 믿음',
    correctConcept:'전반사는 빛이 굴절률이 큰 매질에서 작은 매질로 진행할 때 입사각이 임계각보다 클 경우에만 일어난다',
    sourcePaper:'최정훈 (2015), 중학교 학생들의 빛 관련 오개념 연구, 충북대학교 석사학위논문' },
  { id:'WR4', unitId:'4', dimensionCode:'WR', code:'WR4', name_ko:'굴절 시 파장 불변', name_en:'Wavelength unchanged during refraction',
  ...
  { id:'LD1', unitId:'4', dimensionCode:'LD', code:'LD1', name_ko:'빛 세기 ↑ = 광전자 운동에너지 ↑', name_en:'Brighter light ejects faster photoelectrons',
  ...
  { id:'LD2', unitId:'4', dimensionCode:'LD', code:'LD2', name_ko:'입자성·파동성 동시 발현', name_en:'Wave and particle nature appear simultaneously',
    description:'빛이 입자성과 파동성을 항상 동시에 드러낸다고 믿음',
    correctConcept:'빛은 관찰 방식에 따라 파동성(간섭·회절 실험)이나 입자성(광전효과)으로 나타나며, 두 성질이 동시에 관측되지는 않는다',
    sourcePaper:'물리 예비교사들의 빛의 간섭과 회절에 대한 오개념 분석 (서울대 박사학위논문, 2006)' },
  { id:'LD3', unitId:'4', dimensionCode:'LD', code:'LD3', name_ko:'물질파 파장 = 입자 크기 비례', name_en:'de Broglie wavelength proportional to particle size',
    description:'드브로이 파장이 클수록 입자가 크다고 믿음',
    correctConcept:'드브로이 파장은 λ=h/mv 로 입자의 운동량에 반비례한다. 입자의 크기와는 관계없다',
    sourcePaper:'물리 예비교사들의 빛의 간섭과 회절에 대한 오개념 분석 (서울대 박사학위논문, 2006)' },
  { id:'LD4', unitId:'4', dimensionCode:'LD', code:'LD4', name_ko:'간섭·회절 = 입자성', name_en:'Interference and diffraction explained by particle nature',
